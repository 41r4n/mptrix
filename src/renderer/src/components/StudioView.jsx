...
const STEM_META = {
  ...
  'steel-guitar': { label: 'Steel guitar', icon: '🎸' },
  sitar: { label: 'Sitar', icon: '🪕' },
  synth: { label: 'Sintetizador', icon: '🎹' },
  clavinet: { label: 'Clavinete', icon: '🎹' },
  harpsichord: { label: 'Cravo', icon: '🎹' },
  marimba: { label: 'Marimba', icon: '🎶' },
  xylophone: { label: 'Xilofone', icon: '🎶' },
  vibraphone: { label: 'Vibrafone', icon: '🎶' },
